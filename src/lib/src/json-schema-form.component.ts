...
export class JsonSchemaFormComponent implements DoCheck, OnChanges, OnInit, OnDestroy {
  ...
  @Output() btnClick = new EventEmitter<any>(); // Final layout used to create form
